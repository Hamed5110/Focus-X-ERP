...
SELECT
    ...
    acc.iMasterId AS [No. of Accounts]
FROM (
...
$dt | Export-Csv -Path "C:\Users\Hamed Ali Khan\Focus-X-ERP\tools\diag_status3.csv" -NoTypeInformation -Encoding UTF8
$dt | Select-Object -First 5 | Format-Table -AutoSize | Out-String -Width 200 | Write-Host
